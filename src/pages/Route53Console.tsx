    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900">Route 53</h1>
                    <p className="text-gray-600">Scalable DNS and Domain Name Registration</p>
                </div>
                <Button onClick={() => setIsCreateZoneModalOpen(true)} icon={Plus}>
                    Create hosted zone
                </Button>
            </div>
